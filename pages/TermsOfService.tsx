    ...
    <div className="pt-32 pb-24 animate-fade-in-up">
      <div className="max-w-4xl mx-auto px-6">
        <header className="mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-black serif mb-6">Terms of Service</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-10 text-black font-light leading-relaxed">
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-black serif">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-black serif">2. Use of Website</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-black serif">3. Insurance Quotes</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-black serif">4. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-black serif">5. Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-black serif">6. Governing Law</h2>
            <p>
