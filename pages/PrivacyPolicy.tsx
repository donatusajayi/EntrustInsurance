    ...
    <div className="pt-32 pb-24 animate-fade-in-up">
      <div className="max-w-4xl mx-auto px-6">
        <header className="mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 serif mb-6">Privacy Policy</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-10 text-gray-600 font-light leading-relaxed">
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900 serif">1. Introduction</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900 serif">2. Information Collection</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900 serif">3. Use of Information</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900 serif">4. Information Sharing</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900 serif">5. Data Security</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900 serif">6. Contact Us</h2>
            <p>
